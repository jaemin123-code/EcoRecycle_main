...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _login() async {
    try {
      ...
      // 3. 성공하면 AuthGate에 의해 자동으로 메인으로 이동함 (별도 이동 코드 불필요)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFE8F5E9), // 배경색 (이미지 참고)
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Icon(Icons.recycling, size: 80, color: Colors.teal), // 로고 자리
              const SizedBox(height: 20),
              const Text('에코봇 로그인', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.teal)),
